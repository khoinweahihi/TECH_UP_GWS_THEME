            ...
            {userData && LinkStarIcons && (
                <div className="linkstar">
                    <div className="relative w-full h-full group">
                        ...
                        <div className="relative grid min-h-full backdrop-blur-2xl bg-cover bg-[url('https://s1.ticketm.net/dam/a/c26/f3bc3686-a6c2-4324-a6cb-18ab2441ac26_1339991_TABLET_LANDSCAPE_LARGE_16_9.jpg')]">
