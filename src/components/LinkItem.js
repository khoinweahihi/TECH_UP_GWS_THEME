    ...
    return (
        <React.Fragment>
            <a
                ...
                target="_blank"
                rel="noreferrer"
                className={` flex items-center group rounded-2xl bg-white py-2 px-3 md:py-3 mb-4 md:px-4 last:mb-0 transition-all border-2  hover:bg-gradient-to-r  from-[#EDC33D] to-[#161c6e] outline-none hover:scale-105 text-black ${
